# NoxFlow - Herramienta de Diagramas Isométricos <img width="30" height="30" alt="noxflow" src="https://github.com/user-attachments/assets/56d78887-601c-4336-ab87-76f8ee4cde96" />
...
<b>¡Hola!</b> Soy Stan, si has usado NoxFlow y te ha ayudado, <b>¡realmente agradecería si pudieras donar algo pequeño :)</b> Trabajo a tiempo completo, y encontrar tiempo para trabajar en este proyecto ya es bastante desafiante.
...
Ve a  <b> --> https://NoxzRCW.github.io/NoxFlow/ <-- </b>


------------------------------------------------------------------------------------------------------------------------------
NoxFlow es una potente aplicación web progresiva (PWA) de código abierto para crear hermosos diagramas isométricos. Construido con React y la biblioteca <a href="https://github.com/markmanx/isoflow">Isoflow</a> (Ahora bifurcada y publicada en NPM como noxflow), se ejecuta completamente en tu navegador con soporte sin conexión.

![Screenshot_20250630_160954](https://github.com/user-attachments/assets/e7f254ad-625f-4b8a-8efc-5293b5be9d55)

- **🤝 [CONTRIBUTORS.md](https://github.com/NoxzRCW/NoxFlow/blob/master/CONTRIBUTORS.md)** - Cómo contribuir al proyecto.
...
- **Imágenes Pre-construidas** - Disponibles en `stnsmith/noxflow:latest`
...
- `packages/noxflow-lib` - Biblioteca de componentes React para dibujar diagramas de red (construida con Webpack)
- `packages/noxflow-app` - Aplicación Web Progresiva para crear diagramas isométricos (construida con RSBuild)
