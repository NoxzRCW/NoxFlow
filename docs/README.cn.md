# NoxFlow - 等距图表工具 <img width="30" height="30" alt="noxflow" src="https://github.com/user-attachments/assets/56d78887-601c-4336-ab87-76f8ee4cde96" />
...
<b>嗨！</b> 我是 Stan，如果您使用过 NoxFlow 并觉得它对您有帮助，<b>我会非常感激您能捐助一点点 :)</b> 我全职工作，抽时间来维护这个项目已经很不容易了。
...
------------------------------------------------------------------------------------------------------------------------------
NoxFlow 是一款功能强大的、开源的渐进式 Web 应用（PWA），专为创建精美的等距图表而设计。它基于 React 和 Isoflow（现已 fork 并以 noxflow 名称发布到 NPM）库构建，完全在浏览器中运行，并支持离线使用。

![Screenshot_20250630_160954](https://github.com/user-attachments/assets/e7f254ad-625f-4b8a-8efc-5293b5be9d55)

- **🤝 [CONTRIBUTORS.md](https://github.com/NoxzRCW/NoxFlow/blob/master/CONTRIBUTORS.md)** - 如何为项目做出贡献。
...
访问 https://NoxzRCW.github.io/NoxFlow/
...
NoxFlow 使用 Unlicense 许可证发布，您可以随意使用。
